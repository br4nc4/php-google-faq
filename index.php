...
$db = [
    ...
    [
        ...
        "paragrafo" => [
            ...
            "<ol><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</li></ol>",
            "<li><ul><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li></ul></li>",
            "<li><ul><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ul></li>",
            "<ol><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>",
    ...
    <main>
        <div class="container">
            ...
            for($i=0; $i<count($db); $i++) { 
                $titolo = $db[$i];
                echo "<h4 class='mb-4'>" . $titolo["titolo"] . "</h4>";
            }
            ?>
